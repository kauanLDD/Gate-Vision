      ...
      <aside className="side">
        <div className="brand">
          <div className="brand-logo">
            <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="brand-icon">
            ...
            <span className="brand-name">Vision<em>Gate</em></span>
          </div>
          <p className="brand-copy">Painel operacional para leitura de placas, autorização de entrada e histórico de acessos em tempo real.</p>
        </div>
      ...
      <main className="main">
        <header className="top">
          <div className="top-title">
            ...
            <span>Operação central da portaria</span>
          </div>
