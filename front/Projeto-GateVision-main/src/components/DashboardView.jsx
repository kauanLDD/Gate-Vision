  ...
  return (
    <div className="chart-grid">
      <div className="chart-card">
        <div className="chart-title">Histórico de acessos por dia</div>
        <div className="chart-canvas-wrap"><canvas ref={timelineRef} /></div>
      </div>
      <div className="chart-card">
        <div className="chart-title">Distribuição de acessos</div>
  ...
  return (
    <div className="page-stack">
      <div className="hero-card">
        <div className="hero-grid">
          <div>
            ...
            <p className="section-sub">Resumo do fluxo da portaria, desempenho de liberações e acompanhamento das últimas ocorrências registradas pelo sistema.</p>
      ...
      <div className="dashboard-toolbar">
        <div>
          <label className="login-sub" htmlFor="dashboardFilter">Período dos gráficos</label>
      ...
      <div className="grid-3">
        ...
        <div className="kpi"><div className="kpi-label">Acessos permitidos</div><div className="kpi-val">{liberados}</div><div className="kpi-sub">{percent}% de aprovação</div></div>
      ...
      <div className="card">
        <div className="card-head">Últimos acessos registrados</div>
        <div className="card-body">
          {latest.length ? (
            ...
            <div className="empty">Sem registros para o período selecionado.</div>
          )}
        </div>
      </div>
    </div>
